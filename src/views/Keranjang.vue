...
export default {
  ...
  methods: {
    ...
    hapusKeranjang(id) {
      axios
        ...
        .then(() => {
          this.$toast.error("sudah di cencel", {
            type: "error",
            position: "top-right",
            duration: 3000,
            dismissible: true,
          ...
          axios
            ...
            .then((response) => this.aaaaaa(response.data))
      ...
      if (this.pesan.nama && this.pesan.noMeja) {
        ...
        axios
          ...
          .then(() => {
            ...
            this.$toast.success("Sudah Dipesan:)", {
              type: "success",
              position: "top-right",
              duration: 3000,
              dismissible: true,
  ...
  computed: {
    totalHarga() {
      return this.keranjangs.reduce(function (acc, data) {
        return acc + data.product.harga * data.jumlah_pemesanan;
      }, 0);
    },
  },
};
